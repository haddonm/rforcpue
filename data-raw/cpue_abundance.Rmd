...
for (yr in c(2015,2016,2017,2018)) {
  pick <- which(ab2b$year == yr)
  plot(ab2b$hours[pick],ab2b$catch[pick],type="p",xlab="hours",ylab="catch kg)",
       ylim=c(0,800))
  label <- paste0(yr,"__",round(sum(ab2b$catch[pick],na.rm=TRUE)/1000,2))
  text(0,700,label,cex=1.0,pos=4)
}
